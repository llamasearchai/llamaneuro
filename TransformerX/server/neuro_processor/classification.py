    ...
    class DeepConvNet(nn.Module):
        ...
        def __init__(
            ...
            self.conv4 = nn.Conv2d(
                50, 100, kernel_size=(1, 5), stride=1, padding=(0, 2)
            )
            ...
            self.conv5 = nn.Conv2d(
                100, 200, kernel_size=(1, 5), stride=1, padding=(0, 2)
            )
            ...
            out_time_length = self._calculate_output_dim(
                out_time_length, 5, 2, 1
            )  # After pool1
            out_time_length = self._calculate_output_dim(
                out_time_length, 5, 2, 1
            )  # After pool2
        ...
        def _calculate_output_dim(
            self, input_dim: int, kernel_size: int, stride: int, padding: int
        ) -> int:
