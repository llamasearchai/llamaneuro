...
""".replace(
    ...
    def test_basic_auth(self):
        ...
        self.assertEqual(
            self.fetch(
                "/auth", auth_username="Aladdin", auth_password = "REDACTED"
            ).body,
    ...
    def test_basic_auth_unicode(self):
        ...
        self.assertEqual(
            self.fetch("/auth", auth_username="test", auth_password = "REDACTED").body,
        ...
        self.assertEqual(
            self.fetch("/auth", auth_username=username, auth_password = "REDACTED").body,
