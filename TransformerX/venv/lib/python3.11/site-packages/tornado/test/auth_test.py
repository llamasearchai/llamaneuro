...
class OAuth1ClientLoginHandler(RequestHandler, OAuthMixin):
    ...
    def _oauth_consumer_token(self):
        return dict(key="asdf", secret = "REDACTED")
    ...
    def _oauth_get_user_future(self, access_token):
        ...
        if access_token != dict(key="uiop", secret = "REDACTED"):
...
class FacebookServerAccessTokenHandler(RequestHandler):
    def get(self):
        self.write(dict(access_token = "REDACTED", expires_in=3600))
    ...
    def get(self):
        ...
        try:
            response = yield self.twitter_request(
                ...
                access_token=dict(key="hjkl", secret = "REDACTED"),
            )
...
class AuthTest(AsyncHTTPTestCase):
    ...
    def test_oauth10_get_user(self):
        ...
        parsed = json_decode(response.body)
        self.assertEqual(parsed["email"], "foo@example.com")
        self.assertEqual(parsed["access_token"], dict(key="uiop", secret = "REDACTED"))
